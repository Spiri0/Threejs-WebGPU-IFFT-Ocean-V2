	...
	class OceanMaterial extends entity.Component {
		...
		Init(params) {
			...
			const wgslShaderParams = {
				...
				derivatives0_sampler: texture(params.cascades[0].derivative),
				derivatives1_sampler: texture(params.cascades[1].derivative),
				derivatives2_sampler: texture(params.cascades[2].derivative),
				derivatives3_sampler: texture(params.cascades[3].derivative),
				...
				jacobian0_sampler: texture(params.cascades[0].jacobian),
				jacobian1_sampler: texture(params.cascades[1].jacobian),
				jacobian2_sampler: texture(params.cascades[2].jacobian),
				jacobian3_sampler: texture(params.cascades[3].jacobian),
