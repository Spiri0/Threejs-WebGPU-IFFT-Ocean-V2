...
export const wave_cascade = (() => {
    ...
    class WaveCascade extends entity.Component {
        ...
        /*
        document.getElementById("testfield4").value = this.params_.renderer.getMaxAnisotropy();
        document.getElementById("testfield5").value = Object.keys(this.displacement);
        document.getElementById("testfield6").value = this.displacement.mipmaps.length;
        */
